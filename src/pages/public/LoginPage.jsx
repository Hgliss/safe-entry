...
const LoginPage = () =>{
    ...
    <div className="min-h-screen flex font-sans">
        {/* LADO IZQUIERDO */}  
        <div className="hidden md:flex w-1/2 items-center justify-center bg-gradient-to-br from-info to-background p-10">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center bg-background">
            <div className="max-w-md w-full p-10">
                ...
                <p className="text-center text-darkBlue mb-6 text-sm">
